  ...
  const fetchData = async () => {
    try {
      ...
      if (result.success && result.data) {
        ...
        console.log(`✅ Sertifikat Halal loaded: ${result.data.length} records (${result.source || 'unknown'} source)`)
      } else {
        console.error('Error loading Sertifikat Halal data:', result.error)
        setDataList([])
      }
    } catch (error) {
      console.error('Error loading Sertifikat Halal data:', error)
      setDataList([])
    } finally {
      setLoading(false)
    }
  ...
  const fetchIkmBinaanData = async () => {
    try {
      ...
      if (result.success && result.data) {
        ...
        console.log(`✅ IKM Binaan loaded: ${result.data.length} records for Sertifikat Halal selection`)
      } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        await fetchData()
        resetForm()
        alert(editingId ? 'Sertifikat Halal berhasil diperbarui!' : 'Sertifikat Halal berhasil disimpan!')
      } else {
        alert('Gagal menyimpan data: ' + result.message)
      }
    } catch (error) {
      console.error('Error saving Sertifikat Halal data:', error)
  ...
  const handleDelete = async (id) => {
    if (confirm('Yakin ingin menghapus data ini?')) {
      try {
        ...
        console.error('Error deleting Sertifikat Halal data:', error)
        ...
        <Layout>
          <div className="flex items-center justify-center min-h-screen">
            <div className="text-center">
              ...
              <p className="mt-4 text-gray-600">Memuat data Sertifikat Halal...</p>
            </div>
          </div>
        </Layout>
      </AdminRoute>
  ...
  return (
    <AdminRoute>
      <Layout>
        <div className="p-8">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-gray-900">Sertifikat Halal</h1>
            <p className="text-gray-600">Kelola data Sertifikat Halal untuk IKM Binaan</p>
          </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Cari data Sertifikat Halal..."
                />
